const { averageFlowWithIccid, runtimeFlowIccid,runtimeAccumulatingFlow, ActualStart, ActualEnd } = require('../repositories/postgress_repository');
...
module.exports = { parallelcaleCalcsFunc }
