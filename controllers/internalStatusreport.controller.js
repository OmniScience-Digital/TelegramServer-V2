...
exports.Statusreportcontroller = async (triggerStart, triggerEnd, shift) => {
    try {
        ...
        const chatId = (process.env.NODE_ENV==="development")?(process.env.chartIDTest):(process.env.DIGITALPUTONSLACK);
        ...
        for (let index = 0; index < reports.length; index++) {
            try {
                ...
                // Optionally, you can log the index or any relevant info for debugging
            }
        }
